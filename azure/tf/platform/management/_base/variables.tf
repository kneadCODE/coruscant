...
variable "logs_deploy_st" {
  type        = bool
  description = "Deploy logs storage account for archival?"
  default     = false
}

variable "logs_deploy_law" {
  type        = bool
  description = "Deploy Log Analytics Workspace for hot logs?"
  default     = false
}

variable "backup_deploy_rsv" {
  type        = bool
  description = "Deploy Recovery Services Vault for IaaS backups?"
  default     = false
}

variable "backup_deploy_bvault" {
  type        = bool
  description = "Deploy Backup Vault for PaaS backups (PostgreSQL, etc.)?"
  default     = false
}
